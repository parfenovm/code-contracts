...
class Func {
  ...
  @Contract.Ensures((result: string | null, instance: Func) => result !== null && Contract.OldValue<string>('Func.test_ensures.instance.test', instance.test) === 'hi!', 'Result should not be null')
